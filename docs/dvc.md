...
The pipeline is composed of 5 stages: `prepare`, `preview`, `train`, `export`, and `evaluate`. Each stage is implemented in a separate script in the `src` directory.
...
1. Create tiles
2. Pull raw data + labelstudio annotations from S3
